...
MODEL                  = sat
MODULES                = rt_logging.c rtGetInf.c rtGetNaN.c rt_nonfinite.c sat.c sat_capi.c sat_data.c sat_tgtconn.c rt_logging_mmi.c rtw_modelmap_utils.c raccel_main_new.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c
MAKEFILE               = sat.mk
...
MASTER_ANCHOR_DIR      = 
START_DIR              = C:\Users\27849\Documents\Stellenbosch\4\Skripsie\repo\matlab
...
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = sat_ref.rsp
COMPILER_COMMAND_FILE     = sat_comp.rsp
