...
#define Q_ROOT2_RECIP 26066 
#define Q_20KHZ (Qnum)(20000.0f / FS * (float)Q_MAX)
...
struct voice {
	...
	IIR filter_left;
	IIR filter_right;
	ADSR envelope_volume;
	ADSR envelope_filter;
	int32_t detune = 0;
	Qnum detune_volume = 0;
	Qnum filter_envelope_start = Q_20KHZ;	
	Qnum filter_envelope_amplitude = 0;
	Qnum velocity;
	Qnum filter_Q_recip = Q_ROOT2_RECIP;
	float freq_start = 20000.0f, freq_end = 20000.0f; //for relative filtering
